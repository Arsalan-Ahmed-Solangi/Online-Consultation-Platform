			...
			<div class="row">
				<div class="col-md-6 col-lg-6 col-xs-12 col-sm-12">
					<div class="form-group mt-2">
						...
						<input type="text" maxlength="30" placeholder="Enter your full name" name="fullname" required class="form-control">
					</div>
				</div>
				<div class="col-md-6 col-lg-6 col-xs-12 col-sm-12">
					<div class="form-group mt-2">
			...
			<div class="row">
				<div class="col-md-6 col-lg-6 col-xs-12 col-sm-12">
					<div class="form-group mt-2">
						...
						<input type="password" maxlength="50" placeholder="Enter your password" name="password" required class="form-control">
					</div>
				</div>
				<div class="col-md-6 col-lg-6 col-xs-12 col-sm-12">
