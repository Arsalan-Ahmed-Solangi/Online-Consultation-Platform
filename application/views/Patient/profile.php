      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          ...
          <div class="card"> 
            ...
            <div class="card-body">
               <form action="<?php echo base_url('Patient_dashboard/updateProfile/').$patient[0]['patient_id'] ?>" method="POST" id="form">
                <div class="row mt-2">
                  <div class="col-lg-6 col-md-6 col-sm-12">
                      <div class="form-group ">
                        <label>Username <span class="text-danger">*</span></label>
                        <input value="<?php echo $patient[0]['username']?>" type="email" required name="username" class="form-control" placeholder="Enter Username">
           ...
           <div class="card"> 
            ...
            <div class="card-body">
              <form action="<?php echo base_url('Patient_dashboard/changePassword');?>" method="POST" > 
                <div class="row mt-2">
