                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <?php 
                                                ...
                                                if($value['status_id'] == 1){
                                                    ?>
                                                    <a href="<?php echo base_url('Patients/status/').$value['patient_id'].'/'.$value['status_id'];?>" class="badge bg-danger">Inactive</a>
                                                    <?php
                                                }else if($value['status_id'] == 2){
                                                    ?>
                                            ...
                                            ?>
                                            <a href="<?php echo base_url('Patients/edit/').$value['patient_id'];?>" class="badge bg-primary"><i class="fa fa-edit"></i></a>
                                        </td>
                                    </tr>
                                    <?php
                                }
